...
public class Main {
    ...
    private static Seleccion seleccionActualGrupo;
    private static Jugador jugadorActual;
    private static boolean salir = false;
    private static Grupo grupoActual;
    private static String menuActual = "general";
    private static String menuAnterior = "";
    private static String menuPadre = "";
    private static Partido partidoActual;
    private static Partido partidoActualGrupo;
    ...
    private static void mostrarMenuGrupoInicial(){
        while (menuActual.equals("grupo") && !salir) {
            mostrarMenuGrupo();
            opcionesDeGrupo();
        }
    }
    private static void mostrarMenuPartidoInicial(){
    ...
    private static void opcionesDeTorneo() {
        Scanner entrada = new Scanner(System.in);
        boolean opcionValida = false;
                ...
                case 6:
                    ...
                    if (!torneoActual.getPartidos().isEmpty()) {
                        ...
                        while (partidoActual == null) {
                            ...
                            if (opcionPartido >= 1 && opcionPartido <= torneoActual.getGrupos().size()) {
    ...
    private static void opcionesDeSeleccion() {
        Scanner entrada = new Scanner(System.in);
        boolean opcionValida = false;
        Seleccion seleccion;
        if (menuAnterior.equals("torneo")) {
    ...
    private static void opcionesDeGrupo() {
        Scanner entrada = new Scanner(System.in);
        boolean opcionValida = false;
    ...
    private static void mostrarMenuPartido() {
        Partido partido;
    ...
    private static void opcionesDePartido() {
        Scanner entrada = new Scanner(System.in);
        boolean opcionValida = false;
        Partido partido;
